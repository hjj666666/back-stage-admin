<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.intro" placeholder="根据简介内容搜索" style="width: 150px;margin-right:20px" class="filter-item" @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.ordernumber" placeholder="根据订单号搜索" style="width: 150px;margin-right:20px" class="filter-item" @keyup.enter.native="handleFilter" />

      <el-select v-model="listQuery.status" placeholder="订单状态" clearable class="filter-item" style="width: 130px;margin-right:20px">
...
<!-- 这里绑定了一个修改数据的回调函数，和edit的是一样 -->
      <el-table-column label="商品简介" min-width="150px">
        <template slot-scope="{row}">
          <span class="link-type" @click="handleUpdate(row)">{{ row.intro}}</span>
        </template>
      </el-table-column>
       
      <el-table-column label="订单编号" prop="ordernumber" align="center" width="100">
        <template slot-scope="{row}">
          <span>{{ row.ordernumber}}</span>
        </template>
      </el-table-column>

      <el-table-column label="订单价格" prop="price" :sortable="'custom'" align="center" width="110">
        <template slot-scope="{row}">
          <span>{{ row.price }}</span>
        </template>
      </el-table-column>
...
-->
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="70px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="订单编号">
            <el-input v-model="temp.ordernumber" placeholder="请输入简介"></el-input>
        </el-form-item>
